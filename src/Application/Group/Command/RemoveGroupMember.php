...
final class RemoveGroupMember extends \Prooph\EventSourcing\AggregateChanged
{
    public const MESSAGE_NAME = 'App\Application\Group\Command\RemoveGroupMember';
    ...
    public static function with(\App\Domain\Group\Model\GroupId $groupId, \App\Domain\Student\Model\StudentId $studentId): RemoveGroupMember
    {
