...
final class GroupMemberWasRemoved extends \Prooph\EventSourcing\AggregateChanged
{
    public const MESSAGE_NAME = 'App\Domain\Group\Event\GroupMemberWasRemoved';
    ...
    public static function with(\App\Domain\Group\Model\GroupId $groupId, \App\Domain\Student\Model\StudentId $studentId): GroupMemberWasRemoved
    {
